...
A static blogging system implemented using NextJS + Notion API and deployed on Vercel. Designed for Notion and all creators.


## Preview effect

Online demo: [https://preview.tangly1024.com/](https://preview.tangly1024.com/) , the project supports multiple theme switching, did not find a favorite theme? [Contribute](/CONTRIBUTING.md) one it~

| Next | Medium | Hexo | Fukasawa |
|--|--|--|--|
| <img src='./docs/theme-next.png' width='300'/> [Preview NEXT](https://preview.tangly1024.com/?theme=next)  | <img src='./docs/theme-medium.png' width='300'/> [Preview MEDIUM](https://preview.tangly1024.com/?theme=medium) | <img src='./docs/theme-hexo.png' width='300'/> [Preview HEXO](https://preview.tangly1024.com/?theme=hexo) | <img src='./docs/theme-fukasawa.png' width='300'/> [Preview FUKASAWA](https://preview.tangly1024.com/?theme=fukasawa) |

## How do I get started?

Build your personal site in just a few minutes, feel free to move on to [my blog](https://tangly1024.com/article/notion-next) View Tutorial 


## Acknowledgements
Thanks to Craig Hart for initiating the Nobelium project
<table><tr align="left">
...
- **Comments**: [Giscus](https://giscus.app/zh-CN), [Gitalk](https://gitalk.github.io), [Cusdis](https://cusdis.com), [Utterances](https://utteranc.es)
- **Icons**: [Fontawesome](https://fontawesome.com/v6/icons/)

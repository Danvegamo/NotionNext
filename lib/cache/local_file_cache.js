...
export async function getCache (key) {
  ...
  // Cache will be invalidated after the expiration date
...
/**
 * Concurrent request to write a file exception; Vercel production environments do not support writing files.
 * @param key
 * @param data

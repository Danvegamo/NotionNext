      ...
      {categories.map(category => {
        ...
        return (
          <Link
            ...
            passHref
            className={(selected
              ? 'hover:text-white dark:hover:text-white bg-yellow-900 text-white '
              : 'dark:text-gray-400 text-gray-500 hover:text-white dark:hover:text-white hover:bg-yellow-900') +

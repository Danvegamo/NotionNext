        ...
        if (link && link.show) {
          ...
          return (
            <Link
              ...
              title={link.to}
              href={link.to}
              className={'py-1.5 px-5 text-base justify-between hover:bg-yellow-400 hover:text-white hover:shadow-lg cursor-pointer font-light flex flex-nowrap items-center ' +
